...
?>
    ...
    <div id="left">
		...
		//thực hiện câu truy vấn
		$result=mysql_query("select a.cate_title,b.title,b.introduce,b.content from category as a, news as b where a.cate_id=b.cate_id and news_id=$id");
		$data=mysql_fetch_assoc($result);
		?>
        	<h2 style=' padding-left:3px;'><?php echo "$data[cate_title]"?></h2>
		...
		require("library/config.php");
		//thực hiện câu truy vấn
		$result3=mysql_query("select news_id,title,images from news where hot_news=1 and news_id< $id order by news_id desc limit 3");
		if(mysql_num_rows($result3)!=0)
		{
			...
			{
               echo"<li>";
               		echo"<a href='detail.php? id=$data3[news_id]'>";
